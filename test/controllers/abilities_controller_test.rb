...
class AbilitiesControllerTest < ActionController::TestCase
  ...
  test "should create ability" do
    assert_difference('Ability.count') do
      post :create, ability: { level: @ability.level, name: @ability.name, requirements: @ability.requirements }
    end
  ...
  test "should update ability" do
    patch :update, id: @ability, ability: { level: @ability.level, name: @ability.name, requirements: @ability.requirements }
    assert_redirected_to ability_path(assigns(:ability))
  end
